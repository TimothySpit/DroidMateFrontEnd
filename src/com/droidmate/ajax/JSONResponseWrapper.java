...
public class JSONResponseWrapper 
{
	 ...
	 * @param result the boolean indicating the result
	 ...
	 * @param parameterName the name of the parameter which should be added.
	 * @param result the boolean indicating the result
	 * @param message the parameters message
	 */
	 ...
	 * @param object the JSON object to be changed
	 * @param result the boolean indicationg the result
