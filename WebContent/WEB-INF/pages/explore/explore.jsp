...
<body>
	<div class="container">
		...
		<!-- top navi controls -->
		<div id="div-exploration-top-navigation" class="row"
			style="display: none;">
			<div class="col-sm-4">
		...
		<div id="div-droidmate-starting-indicator-container"
			class="text-center row" style="display: none;">
			<div id="div-starting-indicator"></div>
			<p id="div-starting-indicator-text"></p>
		</div>

		<!-- APK table containing exploration data -->
		<div id="div-apk-exploration-table-container" class="row"
			style="display: none;">
		...
		<div style="display: none;" class="row"
			id="div-exploration-bottom-navi">
			<div class="col-sm-4">
				<div class="input-group">
					<span class="input-group-btn">
						<button id="button-open-output-folder"
							class="btn btn-default pull-left">Open output folder</button>
					</span> <input type="text" class="form-control"
						value="<%=settings.getOutputFolder()%>"
						placeholder="Path to output folder was not found">
				</div>
			</div>
